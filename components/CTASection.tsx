        ...
        <div className="relative bg-[var(--color-dark)] rounded-[32px] overflow-hidden p-8 md:p-16 flex flex-col lg:flex-row items-center justify-between gap-12 group border border-white/5">
          ...
          <div className="relative w-full lg:w-auto flex-grow flex items-center justify-center lg:justify-end pr-4 sm:pr-0 z-10 mt-16 lg:mt-0">
            ...
            <motion.div
              ...
              className="relative w-[220px] sm:w-[280px] bg-white rounded-3xl overflow-hidden shadow-2xl rotate-[-4deg] group-hover:rotate-[-2deg] transition-transform duration-500 shrink-0 mt-8 lg:mt-12 border-[4px] border-terracotta-dark"
            >
              <Image
